...
<div class="w3-container w3-light-grey w3-opacity w3-padding-8" style="text-align:center; margin-top:60px;">
  <h1 style="color: #797C5D; font-weight: bold">Welcome!!!</h1>
  <br/>
  <br/>
  <img src="/ProjectImages/Dope.jpg">
  <br/>
  <br/>
  <h3 style="color: #797C5D; font-weight: bold">To edit/create playlists, search for tours or browse songs click on links above!</h3>
</div>
